...
public class MonotonicFeatureSelector {
    ...
    private void process() throws Exception {
        ...
        String LcsOfCharacters_Based_Dice_Coefficient_String,
                ...
                CosineSimilarityTokUnTagged_String;
        ...
        NodeList pairs,
                ...
                CosineSimilarityTokUnTagged_NodeList,
...
//             Get the required one
            CosineSimilarityTokUnTagged_NodeList = root.getElementsByTagName("CosineSimilarityTokUnTagged");
            ...
            for (int i = 0; i < pairs.getLength(); i++) {
                 ...
                 */
                CosineSimilarityTokUnTagged_String = CosineSimilarityTokUnTagged_NodeList.item(i).getTextContent();
                ...
                if (i == 0) {
                     ...
                     * 
                     *
                     * String1Id,String2Id,CosineSimilarityTokUnTagged,pair_Quality
                     */
                    line_To_Insert_In_File = "String1Id,"
                            + "String2Id,"
                            + "CosineSimilarityTokUnTagged,"
                            + "pair_Quality";
                 ...
                 */
                line_To_Insert_In_File = appendString(line_To_Insert_In_File, CosineSimilarityTokUnTagged_String, feature_Separator_Char);
