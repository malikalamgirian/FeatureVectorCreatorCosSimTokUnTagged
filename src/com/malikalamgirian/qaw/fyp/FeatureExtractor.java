...
//    private XPathExpression expr;
    ...
    private void process() throws Exception {
        ...
        Element UnProcessed_Doc_Root,
                processed_Doc_Root,
                CosineSimilarityTokUnTagged_Element,
...
//             Select "Tagged Strings"
            ...
            for (int i = 0; i < pairs_Of_UnProcessed_Doc.getLength(); i++) {
                 ...
                 */
                CosineSimilarityTokUnTagged_Element = unProcessed_Doc.createElement("CosineSimilarityTokUnTagged");

                /*
                 * Calculate Raw Similarity
                 * using Standard similarity metrics
                 */
                 CosineSimilarityTokUnTagged_Element.setTextContent(Float.toString((new CosineSimilarity()).getSimilarity(TaggedString1Str, TaggedString2Str)));
                 
                 /*
                  * Add pair
                  */
                pair_UnProcessed.appendChild(CosineSimilarityTokUnTagged_Element);
    ...
    private void setFeature_Extracted_File_URL(Properties properties) throws Exception {
        ...
        try {
             ...
             */
            suffixToAdd = "_cos_sim_tok_un_tagged_features_extracted";
